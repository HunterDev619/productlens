...
export const TooltipContent = ({ ref, className, children, sideOffset = 6, ...props }: Omit<React.ComponentPropsWithoutRef<typeof TooltipPrimitive.Content>, 'children'> & { ref?: React.RefObject<React.ElementRef<typeof TooltipPrimitive.Content> | null>; children: React.ReactNode }) => (
