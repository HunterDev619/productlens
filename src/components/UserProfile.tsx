...
import { Key, SignOut, User, UsersThree } from '@phosphor-icons/react';
      ...
      {isDropdownOpen && (
        <>
          ...
          <div className="absolute bottom-full left-0 z-20 mb-2 w-full min-w-48 rounded-lg border border-gray-200 bg-white py-1 shadow-lg">
            ...
            {/* Menu Items */}
            <div className="py-1">
              <Link href="/apps/profile" onClick={() => setIsDropdownOpen(false)}>
                <Button
                  variant="ghost"
              ...
              <Link href="/apps/reset-password" onClick={() => setIsDropdownOpen(false)}>
                <Button
                  variant="ghost"
                  className="mt-0.5 flex h-auto w-full justify-start gap-3 px-4 py-2 text-sm font-normal text-gray-700"
                >
                  <Key size={16} />
                  Reset password
                </Button>
              ...
              {user.role === UserRole.ADMIN && (
                <Link href="/admin/users" onClick={() => setIsDropdownOpen(false)}>
                  <Button
                    variant="ghost"
                    className="mt-0.5 flex h-auto w-full justify-start gap-3 px-4 py-2 text-sm font-normal text-gray-700"
                  >
