...
export const Header = () => {
  ...
  >
    <div className="mx-auto max-w-7xl px-4 py-2 sm:px-6 sm:py-2.5 lg:px-8">
      <div className="flex min-h-[3.25rem] w-full items-center justify-between md:min-h-[3.75rem]">
        {/* Logo - left corner, black text */}
        <div className="shrink-0 header-logo [&_span]:!from-black [&_span]:!to-black">
